...
namespace Brightside_Dental_Care_Planning
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        protected void ButtonAddDoctor_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "INSERT INTO Doctor (email, password, first_name, last_name) VALUES (@Email, @Password, @FirstName, @LastName)";
            ...
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["dentistdatabaseConnectionString"].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                {
                    ...
                    try
                    {
                        conn.Open();
                        cmd.ExecuteNonQuery();
                        AddSuccessMessage.Text = "You have successfully added a new doctor.";
