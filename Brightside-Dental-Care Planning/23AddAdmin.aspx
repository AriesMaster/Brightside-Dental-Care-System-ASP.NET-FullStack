<%@ Page Title="Add Admin" Language="C#" MasterPageFile="~/Second.Master" AutoEventWireup="true" CodeBehind="23AddAdmin.aspx.cs" Inherits="Brightside_Dental_Care_Planning.WebForm9" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="max-width: 600px; margin: auto; padding: 20px; background-color: #f4f4f4; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <h2 style="text-align: center; font-family: Arial, sans-serif; color: #333;">Add New Admin</h2>
        ...
        <asp:Button ID="ButtonAddAdmin" runat="server" Text="Add Admin" OnClick="ButtonAddAdmin_Click" 
